function SminVFI(wmin, p::Matrix, z::Matrix, Π::Matrix;tol = 0.001, MaxIter = 5000, β::Number = 0.946603693905558, λ1::Number = 0.119345383430366, λ0::Number = 0.994544861919718, r = 0.05/4)
