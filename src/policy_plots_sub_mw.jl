...
savefig("$outdir/quitrate_mw.png")
savefig("$outdir/quitrate_mw.svg")
...
savefig("$outdir/prod_mw.png")
savefig("$outdir/prod_mw.svg")
...
savefig("$outdir/monopprop_mw.png")
savefig("$outdir/monopprop_mw.svg")
...
savefig("$outdir/wagedens_mw.png")
savefig("$outdir/wagedens_mw.svg")
...
savefig("$outdir/avwage_mw.svg")
savefig("$outdir/avwage_mw.png")
...
savefig("$outdir/avwagetype_mw.png")
savefig("$outdir/avwagetype_mw.svg")
...
savefig("$outdir/unemp_mw.png")
savefig("$outdir/unemp_mw.svg")
...
savefig("$outdir/inc_mw.png")
savefig("$outdir/inc_mw.svg")
...
plot!(title = "Medium State", legend = :right)
...
savefig("$outdir/unemp_skill_mw.png")
savefig("$outdir/unemp_skill_mw.svg")
...
savefig("$outdir/avwage_skill_mw.png")
savefig("$outdir/avwage_skill_mw.svg")
...
savefig("$outdir/wageinc_skill_mw.png")
savefig("$outdir/wageinc_skill_mw.svg")
...
savefig("$outdir/wageinc_skillzoom_mw.png")
savefig("$outdir/wageinc_skillzoom_mw.svg")
...
pswf_weighted = plot(; title = "Social Welfare")
...
for i in 1:lastindex(weights)
    ...
    y = y/y[1]
    plot!(subs, y, linecolor = c[i], label = L"\chi" * "= $w")
end

xlabel!("Subsidy in Low State")
ylabel!("Weighted Social Welfare (Normalised)")

savefig("$outdir/swf_mw.png")
savefig("$outdir/swf_mw.svg")